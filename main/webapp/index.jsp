...
<html lang="en">
    ...
    <head>
        ...
        <title>华北水利水电大学-课程问卷调查系统登录</title>
    ...
    <div class="row">
    <div class="col-sm-4 ">
		<img src="img/logo_03.png" class="img-responsive" alt="image">
    </div>
    </div>
        <!-- Top content -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>登录课程问卷调查系统</strong></h1>
...
function checkUsername() {
	...
	$.ajax({
		type : 'POST',
		url : '${webapp}/user/searchUsername',
		async : true,
...
function login(){
	$.ajax({
		...
		success : function(data) {
			if (data.success) {
				if(data.authority==0){
					location.href="${webapp }/system/admin";
